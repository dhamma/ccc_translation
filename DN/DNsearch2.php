...
<table border="0" cellpadding="0" cellspacing="0" width="98%" bgcolor="#EDFFE1">
 ...
 <table border="0" cellpadding="0" cellspacing="0" width="800" bgcolor="#EDFFE1">
    <tr>
    <td><div align="center">　　<a href="../index.htm"><img border="0" width="100%" src="title0.gif" alt="漢譯長部/莊春江譯"></a>
...
<table border="0" cellpadding="0" cellspacing="0" width="95%" bgcolor="#EDFFE1">
 ...
 經號：
     ...
     <td><div align="left">
   <form name="search_form" action="DNsearch.php">
...
for ($i=1; $i<$SutraNo; $i++)
{ 
	if($i<10){$path = "DN0".$i.".htm";}
	if($i>9 and $i<100){$path = "DN".$i.".htm";}
	...
	$linkdata="DNsearch1.php?".$keyword1;
...
if($remain>0)
{
	$linkdata="DNsearch2.php?"."str=".$keywordT."&fn=".$FoundNo."&done=".$done;
