...
<table border="0" cellpadding="0" cellspacing="0" width="95%" bgcolor="#EDFFE1">
    <tr>
     <td><div align="right">
   <form name="search_form" action="sn.php"><span style="font-size: 20pt; color: #525000">
 經號：
     ...
     <td><div align="left">
   <form name="search_form" action="SNsearch.php">
...
$keywordlen =mb_strlen($keyword, "utf8");
$file1=fopen("sn1.txt","r");
for ($i=1; $i<$SutraNo; $i++)
{ 
	$name=fgets($file1,2048);
	if($i<10){$path = "SN000".$i.".htm";}
	if($i>9 and $i<100){$path = "SN00".$i.".htm";}
	if($i>99 and $i<1000){$path = "SN0".$i.".htm";}
	if($i>999 and $i<10000){$path = "SN".$i.".htm";}
	...
	$linkdata="SNsearch1.php?".$keyword1;
...
if($remain>0)
{
	$linkdata="SNsearch2.php?"."str=".$keywordT."&fn=".$FoundNo."&done=".$done;
