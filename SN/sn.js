...
// 前一經
	...
	var str_title = '<font color="#3366FF"><span style="font-size:14pt; font-family:新細明體">　<a href="../index.htm">首 頁</a>　<a href="index.htm">目錄/凡例</a>　<a href="SN' + pre_sutra + '.htm">上一經</a>/<a href="SN' + next_sutra + '.htm">下一經</a>　　凡以<font color="#CC3300">檔案<font color="#3366FF">或<font color="#CC3300">紙本印刷<font color="#3366FF">流通者須以<font color="#CC3300">贈送<font color="#3366FF">、<font color="#CC3300">不刪除巴利語經文<font color="#3366FF">為之</font><div id="main_menu"></div>';
	return str_title;
}
